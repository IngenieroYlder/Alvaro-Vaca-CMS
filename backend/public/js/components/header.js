        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20 md:h-auto py-2">
                ...
                <div class="flex items-center space-x-4">
                    <button onclick="openJoinModal()" class="hidden lg:inline-flex items-center px-6 py-2 border border-transparent text-sm font-bold rounded-full text-white shadow-md transform hover:-translate-y-0.5 transition-all cursor-pointer" style="background-color: #F89621 !important;">
